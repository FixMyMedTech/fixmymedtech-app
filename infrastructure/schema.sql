...
INSERT INTO fixmymedtech.device_categories (name, icon, slug) VALUES
  ('Anaesthetic Machines', '⛽', 'anaesthetic_machine'),
  ('Autoclaves and Sterilizers', '🧪', 'autoclave_sterilizer'),
  ('ECG (Electrocardiograph) Machines', '💓', 'ecg_machine'),
  ('Electronic Diagnostic Equipment', '🔍', 'electronic_diagnostic_equipment'),
  ('Electrosurgical Units (ESU) and Cautery Machines', '🔥', 'electrosurgical_unit'),
  ('Endoscopes', '🔭', 'endoscope'),
  ('Incubators (Infant)', '👶', 'infant_incubator'),
  ('Lamps', '💡', 'lamp'),
  ('Nebulizers', '🌫️', 'nebulizer'),
  ('Oxygen Concentrators', '🫧', 'oxygen_concentrator'),
  ('Oxygen Cylinders and Flowmeters', '💨', 'oxygen_cylinder_flowmeter'),
  ('Pulse Oximeters', '🖐️', 'pulse_oximeter'),
  ('Scales', '⚖️', 'scale'),
  ('Sphygmomanometers (B.P. sets)', '🩸', 'sphygmomanometer'),
  ('Stethoscopes', '🩺', 'stethoscope'),
  ('Suction Machines', '🌀', 'suction_machine'),
  ('Operating Theatre and Delivery Tables', '🛏️', 'operating_table'),
  ('Ultrasound Machines', '📡', 'ultrasound_machine'),
  ('X-Ray Machines', '🔬', 'xray_machine'),
